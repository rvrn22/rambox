Ext.define('Webapps.view.add.Add',{
	 extend: 'Ext.window.Window'

	,requires: [
		 'Webapps.view.add.AddController'
		,'Webapps.view.add.AddModel'
	]
				...
				,items: [
					...
					,{
						...
						,items: [
							{
								 xtype: 'textarea'
								,fieldLabel: locale['app.window[8]']+' (<a href="https://github.com/placeholder/webapps/wiki/Inject-JavaScript-Code" target="_blank">'+locale['app.window[9]']+'</a>)'
								,allowBlank: true
								,name: 'js_unread'
