Ext.define('Webapps.view.main.About', {
	...
	,tpl: [
		...
		,'<br />'
		,'<div style="text-align:center;"><a href="https://github.com/placeholder/webapps" target="_blank">GitHub</a> - <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=WU75QWS7LH2CA" target="_blank">'+locale['app.main[25]']+'</a> - <a href="http://webapps.pro" target="_blank">webapps.pro</a></div>'
		,'<br />'
